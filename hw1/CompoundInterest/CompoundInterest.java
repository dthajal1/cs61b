...
public class CompoundInterest {
    ...
    static double futureValue(double presentValue, double rate,
                              int targetYear) {
        int yearDiff = numYears(targetYear);
        return presentValue* Math.pow((1+rate/100), yearDiff);
    }
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        int yearDiff = numYears(targetYear);
        return futureValue(presentValue, rate, targetYear) * Math.pow(1-(inflationRate/100), yearDiff);
    }
    ...
    static double totalSavings(double perYear, int targetYear, double rate) {
        ...
        while (yearDiff > 0) {
            savingEachYear = perYear * Math.pow((1+rate/100), yearDiff);
            total += savingEachYear;
            yearDiff -=1;
        }
        return total;
    }
    ...
    static double totalSavingsReal(double perYear, int targetYear, double rate,
        ...
        int yearDiff = numYears(targetYear);
        return totalSavings(perYear, targetYear, rate) * Math.pow(1-(inflationRate/100), yearDiff);
    }
