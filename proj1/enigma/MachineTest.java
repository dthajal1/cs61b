...
public class MachineTest {
    ...
    Permutation pR1 = new Permutation("(AE) (BN) (CK) (DQ) (FU) (GY) (HW)"
            + " (IJ) (LO) (MP) (RX) (SZ) (TV)", alpha);
    Reflector reflectorB = new Reflector("B", pR1);

    Permutation pR2 = new Permutation("(AR) (BD) (CO) (EJ) (FN) (GT) (HK) (IV)"
            + " (LM) (PW) (QZ) (SX) (UY)", alpha);
    ...
    Permutation pM1 = new Permutation("(AELTPHQXRU) (BKNW) (CMOY) (DFG) "
            + "(IV) (JZ) (S)", alpha);
    MovingRotor movingRotor1 = new MovingRotor("I", pM1, "Q");

    Permutation pM2 = new Permutation("(FIXVYOMW) (CDKLHUP) (ESZ) (BJ) (GR)"
            + " (NT) (A) (Q)", alpha);
    MovingRotor movingRotor2 = new MovingRotor("II", pM2, "E");

    Permutation pM3 = new Permutation("(ABDHPEJT) (CFLVMZOYQIRWUKXSG) (N)",
            alpha);
    MovingRotor movingRotor3 = new MovingRotor("III", pM3, "V");

    Permutation pm4 = new Permutation("(AEPLIYWCOXMRFZBSTGJQNH) (DV) (KU)",
            alpha);
    MovingRotor movingRotor4 = new MovingRotor("IV", pm4, "J");

    Permutation pm5 = new Permutation("(AVOLDRWFIUQ)(BZKSMNHYC) (EGTJPX)",
            alpha);
    MovingRotor movingRotor5 = new MovingRotor("V", pm5, "Z");

    Permutation pm6 = new Permutation("(AJQDVLEOZWIYTS) (CGMNHFUX) (BPRK)",
            alpha);
    ...
    Permutation pm8 = new Permutation("(AFLSETWUNDHOZVICQ) (BKJ) (GXY) (MPR)",
            alpha);
    ...
    public void test() {
        addAvailableRotors();
        Machine m = new Machine(alpha, 5, 3, availableRotors);
        String[] rotorsToInsert = new String[] {"B", "Beta", "III", "II", "I"};
        m.insertRotors(rotorsToInsert);
        m.setRotors("AVAA");
        System.out.println(m.convert("AA"));
    }
